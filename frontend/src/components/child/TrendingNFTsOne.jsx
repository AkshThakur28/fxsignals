                    ...
                    <div className="row g-3">
                        <div className="col-xxl-3 col-sm-6 col-xs-6">
                            <div className="nft-card bg-base radius-16 overflow-hidden">
                                <div className="radius-16 overflow-hidden">
                                    <img
                                        src="admin/assets/images/nft/nft-img1.png"
                                        alt=""
                                ...
                                <div className="p-10">
                                    ...
                                    <div className="d-flex align-items-center gap-8">
                                        <img
                                            src="admin/assets/images/nft/nft-user-img1.png"
                        ...
                        <div className="col-xxl-3 col-sm-6 col-xs-6">
                            <div className="nft-card bg-base radius-16 overflow-hidden">
                                <div className="radius-16 overflow-hidden">
                                    <img
                                        src="admin/assets/images/nft/nft-img2.png"
                                        alt=""
                                        className="w-100 h-100 object-fit-cover"
                                    />
                                </div>
                                <div className="p-10">
                                    ...
                                    <div className="d-flex align-items-center gap-8">
                                        <img
                                            src="admin/assets/images/nft/nft-user-img2.png"
                                            className="w-28-px h-28-px rounded-circle object-fit-cover"
                                            alt=""
                                        />
                                        <span className="text-sm text-secondary-light fw-medium">
                        ...
                        <div className="col-xxl-3 col-sm-6 col-xs-6">
                            <div className="nft-card bg-base radius-16 overflow-hidden">
                                <div className="radius-16 overflow-hidden">
                                    <img
                                        src="admin/assets/images/nft/nft-img3.png"
                                        alt=""
                                        className="w-100 h-100 object-fit-cover"
                                    />
                                </div>
                                <div className="p-10">
                                    ...
                                    <div className="d-flex align-items-center gap-8">
                                        <img
                                            src="admin/assets/images/nft/nft-user-img3.png"
                                            className="w-28-px h-28-px rounded-circle object-fit-cover"
                                            alt=""
                                        />
                                        <span className="text-sm text-secondary-light fw-medium">
                        ...
                        <div className="col-xxl-3 col-sm-6 col-xs-6">
                            <div className="nft-card bg-base radius-16 overflow-hidden">
                                <div className="radius-16 overflow-hidden">
                                    <img
                                        src="admin/assets/images/nft/nft-img4.png"
                                        alt=""
                                        className="w-100 h-100 object-fit-cover"
                                    />
                                </div>
                                <div className="p-10">
                                    ...
                                    <div className="d-flex align-items-center gap-8">
                                        <img
                                            src="admin/assets/images/nft/nft-user-img4.png"
                                            className="w-28-px h-28-px rounded-circle object-fit-cover"
                                            alt=""
                                        />
                                        <span className="text-sm text-secondary-light fw-medium">
