  ...
  return (
    <BrowserRouter>
      ...
      <Route exact path="/" element={<SignInPage />} />
        ...
        <Route exact path="/add-news" element={<AddNewsPage />} />
        ...
        <Route exact path="/edit-news" element={<EditNewsPage />} />
        ...
        <Route exact path="/market-outlook" element={<MarketOutlookPage />} />
        ...
        <Route excat path="/user-edit" element={<UserEditPage />} />
